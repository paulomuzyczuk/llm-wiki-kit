...
- [ ] Ch.5 — Organizations and Money  (batch 7 [5a]: full synthesis → [[open-source-economics]], [[corporate-open-source-participation]], [[government-and-open-source]], [[open-source-contracting]]; enriched [[open-source-governance]] — Ch.5 continues in batches 8–9)
- [ ] Ch.6 — Communications
